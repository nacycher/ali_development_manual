...
/**
 * 06 为什么建议初始化 HashMap 的容量大小？
 */
public class A06InitHashMapWithSize {
    private static final Integer HASH_MAP_INIT_SIZE = 5000000;

    /**
     * HashMap使用过程中存在扩容机制，重建HashMap时，性能消耗非常大
     *
     * hashMap默认初始化大小是16
     * 默认装载因子是3/4(0.75),
     * 当装载个数达到临界值(16*0.75)时，会进行扩容，扩容为原来的2倍
     * 个数始终是2的n次方，所以扩容为原来的2倍
     */
